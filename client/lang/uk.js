    ...
    data: [
      {
        h: "САМОВИВІЗ",
        p:
          'Менеджер компанії "Ортен" погодить з вами всі нюанси, обговорить зручні для вас дату і час, збере, підготує, упакує замовлений вами товар. При складнощах або різного роду форс-мажорах ми повідомимо вам заздалегідь. Безкоштовна доставка. Компанія “Ортен” здійснює доставку товару безкоштовно по Миколаєву при замовленні від 5 000 гривень.',
      },
      {
    ...
    data: [
      ...
      },
      {
        ...
        li: [
          ...
          "Ремонтуємо комп'ютери, принтери, БФП;",
          "Заправляємо, реставруємо картриджі для лазерних принтерів.",
        ],
      },
      {
