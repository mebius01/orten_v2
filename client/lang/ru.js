    ...
    data: [
      {
        h: "САМОВЫВОЗ",
        p:
          "Менеджер компании “Ортэн” согласует с вами все нюансы, обговорит удобные для вас дату и время, соберет, подготовит, упакует заказанный вами товар. При сложностях или различного рода форс-мажорах вы будете уведомлены заранее. Бесплатная доставка. Компания “Ортэн” доставит товар бесплатно по Николаеву при заказе от 5 000 гривен.",
      },
      {
    ...
    data: [
      ...
      },
      {
        ...
        li: [
          ...
          "Ремонтируем компьютеры, принтеры, МФУ;",
          "Заправляем, реставрируем картриджи для лазерных принтеров.",
        ],
      },
      {
